package com.qingyuanos.delivery.example.logbacklogging;
...
public class SLF4JWithLogback {
	...
	static final Logger LOG = LoggerFactory.getLogger(SLF4JWithLogback.class);

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		SLF4JWithLogback console = new SLF4JWithLogback();
		console.execute();
	}

	public SLF4JWithLogback() {
	}
